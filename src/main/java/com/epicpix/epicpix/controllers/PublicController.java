...
public class PublicController {
     ...
     public ResponseEntity<?> getImag(){
          return imageService.getAllImages();
     }
     
     @PostMapping("/get-img/{id}")
     public Optional<Images> getImgById(@PathVariable String id){
         return imageService.getImgById(id);
     }
}
